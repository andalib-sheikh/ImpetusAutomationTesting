...
public class AdminPageTests extends BasePage{
	...
	public void test01(String Min_Exp, String Max_Exp, String Country, String Keyword, String JobTitle) throws Exception
	{
		try {
		adminPage.test01(Min_Exp, Max_Exp, Country, Keyword, JobTitle);
